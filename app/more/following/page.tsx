...
export default async function FollowingPage(){
    ...
    return <div className="min-h-screen w-full dark:bg-zinc-900 bg-gray-50 flex justify-center items-start md:pl-24 pt-20 pb-20 md:pb-0">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5">
        {data.map((channel)=>{
            return <Link key={channel.id} href={`/profile/${channel.userId}`}>
            <div className="w-80 h-16  rounded-lg dark:bg-black bg-white shadow-sm  flex justify-center items-center">
