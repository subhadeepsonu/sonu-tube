...
export default function AnnoucementCard(props:{
    ...
    return <div className="bg-white dark:bg-transparent dark:text-gray-100 w-[350px] h-80 p-3  shadow-sm flex flex-col justify-start items-start text-black rounded-lg ">
