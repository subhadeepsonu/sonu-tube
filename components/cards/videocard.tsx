...
export default function VideoCard(props:{
    ...
    return <div className="   w-80 h-72 bg-white dark:border-l-zinc-900 dark:bg-black dark:text-white  rounded-lg relative border-2 border-gray-100 shadow-sm flex flex-col justify-center items-start hover:cursor-pointer">
