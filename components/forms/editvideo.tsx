...
import { EditAnnouncementAction } from "@/actions/annoucements/editannoucement"
import { toast } from "sonner"
import { EditVideoAction } from "@/actions/video/editvideo"
...
export default function EditVideo(props:{
    ...
    const mutateAnnouncement = useMutation({
        mutationFn:()=>EditVideoAction(props.id,values.Title,values.Description),
        onSuccess:()=>{
